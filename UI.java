...
public class UI extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(162, 162, 162)
                        .addComponent(mes, javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try
        {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/sdlab","root","Abhi@502");
            Statement stmt=conn.createStatement();
            
            String authorname=author.getText();
            
            String s="select *from books where author='"+authorname+"';";
            
            ResultSet r=stmt.executeQuery(s);
            
            if(r.getRow()==0){
                mes.setText("NO BOOKS FOUND FOR THIS AUTHOR!!!");
                mes.setVisible(true);}
               ...
               while(r.next())
            {
              ...
              String []data={BOOK_ID,NAME,AUTHOR,PRICE};
